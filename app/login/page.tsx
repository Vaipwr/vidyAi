  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-purple-100 p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
        ...
        <p className="text-gray-500 mb-6 text-center">Sign in to your account to continue learning and track your progress.</p>
        <form className="flex flex-col gap-4 w-full" onSubmit={handleSubmit}>
          ...
          <a href="/register" className="text-center text-primary underline hover:text-primary/80 transition mt-2">Don't have an account? Register</a>
        </form>
      </div>
    </div>
  );
